...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hedgehot', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个无趣灵魂的开发者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hdreamer.hedgehotdreamer.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Hedgehot, 博客', // 网站关键词 英文逗号隔开
